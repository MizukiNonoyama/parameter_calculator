...
public class Config {
	...
	public final static int neuron_output_size = 3;
	...
	public static boolean useAvg = false;
	
	public static double getEta(int epoch) {
		return  0.05 * Math.pow(2, -0.0005 * epoch);//0.05 / Math.sqrt((double)epoch / 10.0 + 1.0) + 0.00001;
	}
